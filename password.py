...
class GUI():
    def __init__(self, master):
        ...
        self.label = Label(text="Password Generator", anchor=N, fg='black', font='arial 20 bold underline')
        ...
        self.generate = Button(text="GENERATE PASSWORD", bd=3, relief='solid', padx=1, pady=1, font='forte 15 bold',
        ...
        self.accept = Button(text="ACCEPT", bd=3, relief='solid', padx=1, pady=1, font='forte 15', fg='darkblue',
        ...
        self.reset = Button(text="RESET", bd=3, relief='solid', padx=1, pady=1, font='forte 15', fg='darkblue',
    ...
    def accept_fields(self):
        with sqlite3.connect("users.db") as db:
            ...
            if cursor.fetchall():
                ...
                insert = str("INSERT INTO users(Username, GeneratedPassword) VALUES(\'%s\', \'%s\');" % (
                self.n_username.get(), self.n_generatedpassword.get()))
